...
\newboolean{full_colors}
\setboolean{full_colors}{true}
...
\usepackage{graphicx}
\graphicspath{{figs/}{logos/}{chapitre1/figs/}{chapitre2/figs/}{chapitre3/figs/}{chapitre4/figs/}{chapitre5/figs/}{appendixA/figs/}{appendixB/figs/}{appendixC/figs/}}
...
\PassOptionsToPackage{automark}{scrlayer-scrpage}
    ...
    \ifthenelse{\boolean{full_colors}}{%
      ...
      \lehead{\mbox{\llap{\small\thepage\kern1em\vline}\hspace*{0.5em}\headmark\hfil}}
      \rohead{\mbox{\hfil{\headmark\hspace{0.5em}}\rlap{\small{\vline}\kern1em\thepage}}}%
    }
...
% subsections
\titleformat{\subsection}{\normalfont\Large\sffamily}{\textsc{\MakeTextLowercase{\thesubsection}}}{1em}{\linespread{0.8}\spacedlowsmallcaps}
% subsubsections
\titleformat{\subsubsection}{\normalfont\sffamily\itshape}{\textsc{\MakeTextLowercase{\thesubsubsection}}}{1em}{\spacedlowsmallcaps\itshape}
...
\newcommand{\kkglu}{K. K. gluon\xspace}
...
\newcommand{\mbottom}{\ensuremath{m_{\Pbottom}}\xspace}
\newcommand{\mW}{\ensuremath{m_{\PW}}\xspace}
\newcommand{\mHplus}{\ensuremath{m_{\PHiggsplus}}\xspace}
\newcommand{\mHpm}{\ensuremath{m_{\PHiggspm}}\xspace}
...
\newcommand{\trg}{\emph{trigger}\xspace}

\newcommand{\aeta}{\ensuremath{\abs{\eta}}\xspace}
\newcommand{\vl}{\emph{vector-like}\xspace}

\newcommand{\beq}{\begin{eqnarray}}
\newcommand{\eeq}{\end{eqnarray}}
\def\lappeq{\mathrel{\rlap{\raise.5ex\hbox{$<$}}{\lower.5ex\hbox{$\sim$}}}}
\def\meg{\Pmu \to \Pe \Pgamma}
\def\topqme{\Ptop \to \Pquark \Pmupm \Pemp}
\def\topqij{\Ptop \to \Pquark \Plepton_i^+ \Plepton_j^-}
...
\DeclareSIUnit\rads{\si{\radian\per\s}}
...
\DeclareRobustCommand{\Pl}{\HepParticle{\ell}{}{}\xspace} % lepton
\DeclareRobustCommand{\Plpm}{\HepParticle{\ell}{}{\pm}\xspace} % charged lepton
\DeclareRobustCommand{\Plmp}{\HepParticle{\ell}{}{\mp}\xspace} % charged lepton
\DeclareRobustCommand{\Plp}{\HepParticle{\ell}{}{+}\xspace} % positive lepton
\DeclareRobustCommand{\Plm}{\HepParticle{\ell}{}{-}\xspace} % negative lepton
\DeclareRobustCommand{\Pal}{\HepAntiParticle{\ell}{}{}\xspace} % anti-lepton
\DeclareRobustCommand{\Pgn}{\HepParticle{\nu}{}{}\xspace} % generic neutrino
\DeclareRobustCommand{\Pgnl}{\HepParticle{\nu}{\ell}{}\xspace} % neutrino (for lepton \ell)
\DeclareRobustCommand{\Pagn}{\HepAntiParticle{\nu}{}{}\xspace} % generic anti-neutrino
\DeclareRobustCommand{\Pagnl}{\HepAntiParticle{\nu}{\ell}{}\xspace} % anti-neutrino (for lepton \ell)
\DeclareRobustCommand{\PV}{\HepParticle{V}{}{}\xspace} % generic vector boson

\DeclareRobustCommand{\PX}{\HepParticle{X}{5/3}{}\xspace} % X vector boson
\DeclareRobustCommand{\PaX}{\HepAntiParticle{X}{5/3}{}\xspace} % X vector boson
\DeclareRobustCommand{\PTp}{\HepParticle{T}{2/3}{}\xspace} % T vector quark
\DeclareRobustCommand{\PBp}{\HepParticle{B}{-1/3}{}\xspace} % B vector quark
\DeclareRobustCommand{\PYp}{\HepParticle{Y}{-4/3}{}\xspace} % Y vector quark

\DeclareRobustCommand{\PY}{\HepParticle{Y}{}{}\xspace} % generic vector boson
\DeclareRobustCommand{\PTT}{\HepParticle{T}{}{}\xspace} % T vector quark
\DeclareRobustCommand{\APTT}{\HepAntiParticle{T}{}{}\xspace} % T vector quark
\DeclareRobustCommand{\Pr}{\HepParticle{r}{}{}\xspace} % T vector quark
\DeclareRobustCommand{\Ph}{\HepParticle{h}{}{}\xspace} % T vector quark
